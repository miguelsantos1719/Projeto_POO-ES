...
public class Main {
	...
	public static void main(String[] args) {
		...
		Troco[] conjuntoTrocos = new Troco[] {troco1, troco2, troco3, troco3, troco1, troco2}; 
		//Troco[] conjuntoTrocos2 = new Troco[] {troco1, troco2, troco3, troco3, troco1, troco2, troco8}; 
